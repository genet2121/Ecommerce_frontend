...
// import ShopNowSection from '../shared/ShopNowSection';
...
//           onClick={() => navigate('/shop/office-supplies')}
//         />
//         <CategoryCard
...
//           onClick={() => navigate('/shop/automotives')}
//         />
//         <CategoryCard
...
// src/Components/ShopPage/Categories.tsx
import React, { useState } from 'react';
import { useNavigate } from 'react-router-dom';
import CategoryCard from '../shared/CategoryCard';
import ShopNowSection from '../shared/ShopNowSection';
import CategoryDetail from '../CategoryPage/CategoryDetail'; // Adjust the import path as needed
    ...
    <div className="flex flex-col mb-9">
      <div className="flex gap-5 justify-between w-full max-md:flex-wrap max-md:max-w-full">
        <div className="flex gap-5 self-start px-5 mt-2.5">
          <div className="grow text-3xl font-bold leading-10 text-slate-700">Top Categories</div>
          <div 
            className="flex gap-2.5 self-start mt-3 text-base font-semibold leading-6 text-purple-900"
            onMouseEnter={handleMouseEnter}
            onMouseLeave={handleMouseLeave}
          >
            <div className="grow cursor-pointer">All Categories</div>
            <img
              loading="lazy"
              alt="all category icon"
              src="https://cdn.builder.io/api/v1/image/assets/TEMP/e69fc8e7a615c8b6b530f6aae19650545aefe21711b0ddab02b4d9e172ffeb45?"
      ...
      {isHovered && (
        <div className="absolute top-20 left-0 right-0 z-50 bg-white shadow-md">
          <CategoryDetail />
        </div>
      )}
